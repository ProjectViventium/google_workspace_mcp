...
def configure_file_logging(logger_name: str = None) -> bool:
    ...
    In normal mode, sets up detailed file logging to 'mcp_server_debug.log' with rotation.
    ...
    try:
        ...
        # Use RotatingFileHandler: max 5MB, keep 2 backups
        ...
        file_handler.setLevel(logging.INFO)  # Changed from DEBUG to INFO to reduce verbosity
